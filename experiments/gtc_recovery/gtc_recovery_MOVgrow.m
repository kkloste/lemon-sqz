function gtc_recovery_MOVgrow(varargin )
% gtc_recovery_MOVgrow( varargin )
%
...
%
ALGORITHM_NAME = 'MOV'; % FILL IN YOUR ALG NAME HERE
...
%% Pre Computations specific to MOV
    n = size(A,1);
    if subgraph_flag == false,
      d = full(sum(A,1))';
...
for which_comm=1:NUM_COMMS,
    ...
    for which_seed=1:length(seeds_to_use),
        ...
        if subgraph_flag == true,
          ...
          cluster_output = MOVgrow( A, seed, 'degrees', d, 'lambda2', lambda2);
        end

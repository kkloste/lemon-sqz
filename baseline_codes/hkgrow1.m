...
%
%    't' : t > 0   scaling paramter expm(t*P)*s,  default is t = 20.
%
%    'eps' : 1 > eps > 0   accuracy paramter,  default is eps = 1e-4.
%
...
% MEX CODE USAGE
% [bestset,cond,cut,vol,hkvec,npushes] = hkgrow_mex(A,set,t,eps,debugflag)
%
